...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    const targetElement = targetRef.current; // Get the target element
    if (!canvas || !targetElement) return; // Ensure both exist

    // fixed single splash color: #ccfe00, normalized and slightly dimmed
    const fixedColor = (() => {
      const hex = "#ccfe00".replace("#", "");
      const r = parseInt(hex.substring(0, 2), 16) / 255;
      const g = parseInt(hex.substring(2, 4), 16) / 255;
      const b = parseInt(hex.substring(4, 6), 16) / 255;
      const intensity = 0.15; // base intensity; visual brightness scales in shaders
    ...
    function clickSplat(pointer) {
      const color = { r: fixedColor.r * 10.0, g: fixedColor.g * 10.0, b: fixedColor.b * 10.0 };
    ...
    const handleFirstMouseMove = (e) => {
      ...
      updatePointerMoveData(pointer, posX, posY, fixedColor);
